...
/* ================================================================ */
/* ==================== sList_delete_Node TEST ==================== */
/* ================================================================ */

void sList_delete_Node_test(void) {

    sNode_t temp = NULL;
    void* data = NULL;

    sList_find(list, (array + 4), &temp);

    CU_ASSERT_PTR_NOT_NULL(temp);

    sList_delete_Node(list, temp, &data);
...
void sList_print_test_suite2(void) {
    ...
    char buffer[BUFFER_SIZE] = "0, 1, 2, 3, 5, 6, 7, 8, 9";
    /* What had been read from a file */
    char file_content[BUFFER_SIZE];
