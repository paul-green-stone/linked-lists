...
int main(int argc, char** argv) {
    ...
    suite2 = CU_add_suite("sList_foreach & test_sList_print", NULL, NULL);
    ...
    /* suite2 */
    if ((CU_add_test(suite2, "sList_foreach_test", sList_foreach_test) == NULL) || (CU_add_test(suite2, "sList_print_test_suite2", sList_print_test_suite2) == NULL)) {
        CU_cleanup_registry();
